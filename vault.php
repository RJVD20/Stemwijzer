...
border-radius: 10px;">
          ...
          <div class="page-header">
            <br><h2 class="specialHead text-center">Kies hier je partij:</h2>
          </div>
          
          <form action="saveVote.php" method="POST">
          <div class="form-group">
            <label>Naam van de stemmer:</label><br>
            
            <input type="text" name="voterName" placeholder="Voer hier je volledige naam in" class="form-control"/><br>

            <label>Email van de stemmer:</label><br>
            <input type="email" name="voterEmail" placeholder="Voer uw mail in" class="form-control"/><br>
            
            <h3 class="normalFont text-center">Selecteer hier een partij waarop u wilt stemmen:</h3><br>
